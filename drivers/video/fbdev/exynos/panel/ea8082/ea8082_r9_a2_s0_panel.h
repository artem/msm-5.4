...
static u8 r9_a2_s0_acl_opr_table[MAX_EA8082_ACL_OPR][1] = {
	{ 0x00 }, /* acl 0% */
	{ 0x01 }, /* acl 8% */
	{ 0x03 }, /* acl 15% */
};
...
static struct maptbl r9_a2_s0_maptbl[MAX_MAPTBL] = {
	...
	[ACL_OPR_MAPTBL] = DEFINE_2D_MAPTBL(r9_a2_s0_acl_opr_table, init_common_table, getidx_acl_opr_table, copy_common_maptbl),
	...
	[DM_DDI_OSC_MAPTBL] = DEFINE_0D_MAPTBL(r9_a2_s0_ddi_osc, init_common_table, NULL, dynamic_mipi_set_ddi_osc),
#endif
#if defined(CONFIG_SUPPORT_FAST_DISCHARGE)
...
static u8 R9_A2_S0_GRAYSPOT_ON_04[] = {
...
static u8 R9_A2_S0_GRAYSPOT_OFF_04[] = {
	0xB4, 0x35, 0x00, 0x00, 0x00
};
#endif
...
static DECLARE_PKTUI(r9_a2_s0_grayspot_on_04) = {
	// to do
};
static DEFINE_VARIABLE_PACKET(r9_a2_s0_grayspot_on_04, DSI_PKT_TYPE_WR, R9_A2_S0_GRAYSPOT_ON_04, 0x11);
...
static DECLARE_PKTUI(r9_a2_s0_grayspot_off_04) = {
	// to do
};
static DEFINE_VARIABLE_PACKET(r9_a2_s0_grayspot_off_04, DSI_PKT_TYPE_WR, R9_A2_S0_GRAYSPOT_OFF_04, 0x11);
#endif
...
static DEFINE_PANEL_MDELAY(r9_a2_s0_wait_90msec, 30);
...
static char R9_A2_S0_DDI_OSC[] = {
	0xF2, 0x00
};

static DEFINE_PKTUI(r9_a2_s0_ddi_osc, &r9_a2_s0_maptbl[DM_DDI_OSC_MAPTBL], 0);
static DEFINE_VARIABLE_PACKET(r9_a2_s0_ddi_osc, DSI_PKT_TYPE_WR, R9_A2_S0_DDI_OSC, 0x41);


static char R9_A2_S0_FOSC_UPDATE1[] = {
	0xF2, 0x90
};
static DEFINE_STATIC_PACKET(r9_a2_s0_fosc_update1, DSI_PKT_TYPE_WR, R9_A2_S0_FOSC_UPDATE1, 0);

static char R9_A2_S0_FOSC_UPDATE2[] = {
	0xF2, 0xB0
};
static DEFINE_STATIC_PACKET(r9_a2_s0_fosc_update2, DSI_PKT_TYPE_WR, R9_A2_S0_FOSC_UPDATE2, 0);
...
#ifdef CONFIG_DYNAMIC_MIPI
#if 0
	&PKTINFO(r9_a2_s0_ddi_osc),
	&PKTINFO(r9_a2_s0_fosc_update1),
	&PKTINFO(r9_a2_s0_fosc_update2),
#endif
#endif
...
static void *r9_a2_s0_grayspot_on_cmdtbl[] = {
	...
	&PKTINFO(r9_a2_s0_grayspot_on_04),
	&PKTINFO(r9_a2_s0_gamma_update_enable),
	&DLYINFO(r9_a2_s0_wait_100msec),
	&KEYINFO(r9_a2_s0_level1_key_disable),
};
...
static void *r9_a2_s0_grayspot_off_cmdtbl[] = {
	...
	&PKTINFO(r9_a2_s0_grayspot_off_04),
	&PKTINFO(r9_a2_s0_gamma_update_enable),
	&DLYINFO(r9_a2_s0_wait_100msec),
	&KEYINFO(r9_a2_s0_level1_key_disable),
};
