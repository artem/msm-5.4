...
#define NR_EA8082_MDNIE_REG	(6)

#define EA8082_MDNIE_0_REG		(0xB1)
#define EA8082_MDNIE_0_OFS		(0)
#define EA8082_MDNIE_0_LEN		(132)

#define EA8082_MDNIE_1_REG		(0x81)
#define EA8082_MDNIE_1_OFS		(EA8082_MDNIE_0_OFS + EA8082_MDNIE_0_LEN)
#define EA8082_MDNIE_1_LEN		(1)

#define EA8082_MDNIE_2_REG		(0xB2)
#define EA8082_MDNIE_2_OFS		(EA8082_MDNIE_1_OFS + EA8082_MDNIE_1_LEN)
#define EA8082_MDNIE_2_LEN		(130)

#define EA8082_MDNIE_3_REG		(0x87)
#define EA8082_MDNIE_3_OFS		(EA8082_MDNIE_2_OFS + EA8082_MDNIE_2_LEN)
#define EA8082_MDNIE_3_LEN		(2)

#define EA8082_MDNIE_4_REG		(0x85)
#define EA8082_MDNIE_4_OFS		(EA8082_MDNIE_3_OFS + EA8082_MDNIE_3_LEN)
#define EA8082_MDNIE_4_LEN		(1)

#define EA8082_MDNIE_5_REG		(0x83)
#define EA8082_MDNIE_5_OFS		(EA8082_MDNIE_4_OFS + EA8082_MDNIE_4_LEN)
#define EA8082_MDNIE_5_LEN		(1)
#define EA8082_MDNIE_LEN		(EA8082_MDNIE_0_LEN + EA8082_MDNIE_1_LEN + EA8082_MDNIE_2_LEN + EA8082_MDNIE_3_LEN + EA8082_MDNIE_4_LEN + EA8082_MDNIE_5_LEN)
...
static u8 EA8082_CCD_CHKSUM_PASS[EA8082_CCD_STATE_LEN] = { 0x00 };
...
static struct resinfo ea8082_restbl[] = {
	...
	[RES_CCD_CHKSUM_PASS] = {
		...
		.data = EA8082_CCD_CHKSUM_PASS,
		.dlen = ARRAY_SIZE(EA8082_CCD_CHKSUM_PASS),
		.resui = NULL,
		.nr_resui = 0,
	},
#endif
